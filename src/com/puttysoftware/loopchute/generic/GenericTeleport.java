...
public abstract class GenericTeleport extends MazeObject {
    ...
    // Constructors
    protected GenericTeleport(final boolean doesAcceptPushInto, final String attrName) {
	super(false, false, doesAcceptPushInto, false, false, false, false, true, false);
	...
	return LoopChute.getApplication().getMazeManager().getMaze().getPlayerLocationW();
    }
	...
	LoopChute.getApplication().showMessage(this.getName() + ": Destination (" + (this.destCol + 1) + ","
