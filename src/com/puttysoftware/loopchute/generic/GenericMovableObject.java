...
public abstract class GenericMovableObject extends MazeObject {
    ...
    // Constructors
    protected GenericMovableObject(final boolean pushable, final boolean pullable, final String attrName) {
	...
	this.savedObject = LoopChute.getApplication().getObjects().readMazeObject(reader, formatVersion);
	return this;
    }
