...
public class MazeObjectList {
	...
	final MazeObject[] allObjects = { new Empty(), new Grass(), new Dirt(), new Sand(), new Snow(), new Tundra(),
		...
		new BridgedSlimeVertical(), new BridgedWaterHorizontal(), new BridgedWaterVertical(), new BlueCarpet(),
		new CyanCarpet(), new GreenCarpet(), new MagentaCarpet(), new OrangeCarpet(), new PurpleCarpet(),
		new RedCarpet(), new RoseCarpet(), new SeaweedCarpet(), new SkyCarpet(), new WhiteCarpet(),
		new YellowCarpet(), new Player(), new SunStone(), new MoonStone(), new Wall(), new InvisibleWall(),
		new FakeWall(), new BreakableWallHorizontal(), new BreakableWallVertical(), new BlueWallOff(),
		new BlueWallOn(), new GreenWallOff(), new GreenWallOn(), new MagentaWallOff(), new MagentaWallOn(),
		new OrangeWallOff(), new OrangeWallOn(), new PurpleWallOff(), new PurpleWallOn(), new RedWallOff(),
		new RedWallOn(), new RoseWallOff(), new RoseWallOn(), new SeaweedWallOff(), new SeaweedWallOn(),
		new SkyWallOff(), new SkyWallOn(), new WhiteWallOff(), new WhiteWallOn(), new YellowWallOff(),
		new YellowWallOn(), new CyanWallOff(), new CyanWallOn(), new Key(), new Lock(), new BlueKey(),
		new BlueLock(), new GreenKey(), new GreenLock(), new MagentaKey(), new MagentaLock(), new OrangeKey(),
		new OrangeLock(), new PurpleKey(), new PurpleLock(), new RedKey(), new RedLock(), new RoseKey(),
		new RoseLock(), new SeaweedKey(), new SeaweedLock(), new SkyKey(), new SkyLock(), new WhiteKey(),
		new WhiteLock(), new YellowKey(), new YellowLock(), new CyanKey(), new CyanLock(), new BlueCrystal(),
		...
		new HorizontalBarrier(), new VerticalBarrier(), new BarrierGenerator(), new EnragedBarrierGenerator(),
		new IcedBarrierGenerator(), new PoisonedBarrierGenerator(), new ShockedBarrierGenerator(), new Bow(),
		new IceBow(), new FireBow(), new PoisonBow(), new ShockBow(), new GhostBow(), new Crevasse(),
		new AnnihilationWand(), new WallMakingWand(), new TeleportWand(), new WallBreakingWand(),
	...
	int objectCount = 0;
	for (int x = 0; x < objects.length; x++) {
	    if (objects[x].isUsable() && !objects[x].isOfType(TypeConstants.TYPE_BOW)) {
