...
public abstract class GenericButton extends MazeObject {
    ...
    // Constructors
    protected GenericButton(final GenericToggleWall off, final GenericToggleWall on, final int tc) {
	super(false, false);
	this.offState = off;
	this.onState = on;
	...
	LoopChute.getApplication().getMazeManager().getMaze().findAllObjectPairsAndSwap(this.offState, this.onState);
