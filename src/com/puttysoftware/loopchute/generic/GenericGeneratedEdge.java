...
public abstract class GenericGeneratedEdge extends MazeObject {
    ...
    // Constructors
    protected GenericGeneratedEdge(final String n, final String b, final String p, final String s1, final String s2,
	    final String d) {
	super(false, false);
	...
	return this.plural + " are transitions in the " + this.dirName + " direction, between " + this.source1 + " and "
		+ this.source2 + ".";
    }

    @Override
    public MazeObject clone() {
	return new GeneratedEdge(this.name, this.baseName, this.plural, this.source1, this.source2, this.dirName);
    }
