...
public abstract class GenericRandomInvisibleTeleport extends GenericRandomTeleport {
    // Constructors
    public GenericRandomInvisibleTeleport(final int newRandomRangeY, final int newRandomRangeX, final String attrName) {
	...
	return me.editTeleportDestination(MazeEditor.TELEPORT_TYPE_RANDOM_INVISIBLE);
    }
