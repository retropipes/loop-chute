...
public class BreakableWallHorizontal extends GenericWall {
	...
	try {
	    final MazeObject left = m.getCell(dirX - 1, dirY, dirZ, MazeConstants.LAYER_OBJECT);
	...
	try {
	    final MazeObject right = m.getCell(dirX + 1, dirY, dirZ, MazeConstants.LAYER_OBJECT);
