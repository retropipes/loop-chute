...
public class InvisibleOneShotChainTeleport extends GenericInvisibleTeleport {
	...
	super(destinationRow, destinationColumn, destinationFloor, "one_shot_chain");
    }
	...
	return me.editTeleportDestination(MazeEditor.TELEPORT_TYPE_INVISIBLE_ONESHOT_CHAIN);
    }
