...
public class GraphicsManager {
    ...
    public static BufferedImageIcon getImage(final String name, final String baseName, final int transformColor,
	    final String attrName, final int attrColor) {
	// Get it from the cache
	return ImageCache.getCachedImage(name, baseName, transformColor, attrName, attrColor);
    }
	...
	try {
	    ...
	    final URL url = GraphicsManager.LOAD_CLASS.getResource(GraphicsManager.LOAD_PATH + normalName + ".png");
    ...
    public static BufferedImageIcon getTransformedImage(final String name, final String baseName,
	    final int transformColor, final String attrName, final int attrColor) {
	try {
	    final BufferedImageIcon icon = GraphicsManager.getImage(name, baseName, transformColor, attrName,
		    attrColor);
	...
	try {
	    final BufferedImageIcon icon4 = GraphicsManager.getCompositeImage(icon1, icon2);
