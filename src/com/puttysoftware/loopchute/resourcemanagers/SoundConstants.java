...
public class SoundConstants {
    ...
    public static final int SOUND_BARRIER = 26;
    public static final int SOUND_GENERATE = 27;
    public static final int SOUND_ARROW = 28;
    public static final int SOUND_ARROW_DIE = 29;
    public static final int SOUND_CREATE = 30;
    public static final int SOUND_DESTROY = 31;
    // Package-Protected Constants
    static final String[] SOUND_NAMES = { "logo", "action_failed", "button", "crack", "down", "finish", "grab",
	    "identify", "into_pit", "ow", "push_pull", "push_pull", "sink_block", "slime", "spring", "sun_stone",
	    "teleport", "unlock", "up", "walk", "walk_failed", "walk_ice", "walk_lava", "walk_slime", "walk_water",
	    "water", "barrier", "generate", "arrow", "arrow_die", "create", "destroy" };
