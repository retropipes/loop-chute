...
public class MenuManager {
    ...
    private JMenuItem fileNew, fileOpen, fileOpenGame, fileImportGame, fileClose, fileSave, fileSaveAs, fileSaveGame,
	    fileExportGame, fileExit;
    ...
    private JMenuItem editorGoToLocation, editorGoToDestination, editorUpOneFloor, editorDownOneFloor, editorUpOneLevel,
	    ...
	    editorLevelPreferences, editorMazePreferences, editorSetStartPoint;
    private JMenuItem editorFillFloor, editorFillLevel, editorFillFloorRandomly, editorFillLevelRandomly,
	    editorFillFloorLayer, editorFillLevelLayer, editorFillFloorLayerRandomly, editorFillLevelLayerRandomly,
	    editorFillRuleSets;
	...
	this.editorFillFloorLayer = new JMenuItem("Fill Current Floor and Layer");
	this.editorFillLevelLayer = new JMenuItem("Fill Current Level and Layer");
	this.editorFillFloorLayerRandomly = new JMenuItem("Fill Current Floor and Layer Randomly");
	this.editorFillLevelLayerRandomly = new JMenuItem("Fill Current Level and Layer Randomly");
	...
	public void actionPerformed(final ActionEvent e) {
		...
		if (src instanceof JMenuItem) {
		    ...
		    final int menuCount = MenuManager.this.mainMenuBar.getMenuCount();
		    for (int x = 0; x < menuCount; x++) {
			final JMenu menu = MenuManager.this.mainMenuBar.getMenu(x);
