...
public class MazeEditor {
    ...
    private static String[] choices = new String[] { "Edit Destination 1", "Edit Destination 2",
	...
	final MazeObjectList objectList = LoopChute.getApplication().getObjects();
	...
	this.groundEditorAppearances = objectList.getAllGroundLayerEditorAppearances();
	this.objectEditorAppearances = objectList.getAllObjectLayerEditorAppearances();
	...
	if (w != 0) {
	    // Level Change
	    LoopChute.getApplication().getMazeManager().getMaze().switchLevelOffset(w);
	    this.fixLimits();
	    this.setUpGUI();
	}
	this.checkMenus();
	...
	for (x = this.evMgr.getViewingWindowLocationX(); x <= this.evMgr.getLowerRightViewingWindowLocationX(); x++) {
		...
		try {
		    ...
		    final String name1 = obj1.editorRenderHook(y, x, this.elMgr.getEditorLocationZ());
		    this.drawGrid[xFix][yFix].setIcon(GraphicsManager.getImage(name1, obj1.getBaseName(),
			    obj1.getTemplateColor(), obj1.getAttributeName(), obj1.getAttributeTemplateColor()));
		} catch (final ArrayIndexOutOfBoundsException ae) {
		    this.drawGrid[xFix][yFix].setIcon(GraphicsManager.getImage("Void", "Void",
			    ColorConstants.COLOR_NONE, "", ColorConstants.COLOR_NONE));
	...
	for (x = this.evMgr.getViewingWindowLocationX(); x <= this.evMgr.getLowerRightViewingWindowLocationX(); x++) {
		...
		yFix = y - this.evMgr.getViewingWindowLocationY();
		try {
		    final MazeObject obj1 = m.getCell(y, x, this.elMgr.getEditorLocationZ(),
			    MazeConstants.LAYER_GROUND);
		    final MazeObject obj2 = m.getCell(y, x, this.elMgr.getEditorLocationZ(),
			    MazeConstants.LAYER_OBJECT);
		    final BufferedImageIcon img1 = GraphicsManager.getImage(
			    obj1.editorRenderHook(y, x, this.elMgr.getEditorLocationZ()), obj1.getBaseName(),
			    obj1.getTemplateColor(), obj1.getAttributeName(), obj1.getAttributeTemplateColor());
		    final BufferedImageIcon img2 = GraphicsManager.getImage(
			    obj2.editorRenderHook(y, x, this.elMgr.getEditorLocationZ()), obj2.getBaseName(),
			    obj2.getTemplateColor(), obj2.getAttributeName(), obj2.getAttributeTemplateColor());
		    if (u == y && v == x) {
			final MazeObject obj3 = new Player();
			final BufferedImageIcon img3 = GraphicsManager.getImage(
				obj3.gameRenderHook(y, x, m.getPlayerLocationZ()), obj3.getGameBaseName(),
				obj3.getGameTemplateColor(), obj3.getGameAttributeName(),
				obj3.getGameAttributeTemplateColor());
			this.drawGrid[xFix][yFix].setIcon(GraphicsManager.getVirtualCompositeImage(img1, img2, img3));
		    } else {
			this.drawGrid[xFix][yFix].setIcon(GraphicsManager.getCompositeImage(img1, img2));
		    }
		} catch (final ArrayIndexOutOfBoundsException ae) {
		    this.drawGrid[xFix][yFix].setIcon(GraphicsManager.getImage("Void", "Void",
			    ColorConstants.COLOR_NONE, "", ColorConstants.COLOR_NONE));
	...
	try {
	    final MazeObject obj1 = app.getMazeManager().getMaze().getCell(y, x, this.elMgr.getEditorLocationZ(),
		    MazeConstants.LAYER_GROUND);
	    final MazeObject obj2 = app.getMazeManager().getMaze().getCell(y, x, this.elMgr.getEditorLocationZ(),
		    MazeConstants.LAYER_OBJECT);
	    final BufferedImageIcon img1 = GraphicsManager.getImage(
		    obj1.editorRenderHook(y, x, this.elMgr.getEditorLocationZ()), obj1.getBaseName(),
		    obj1.getTemplateColor(), obj1.getAttributeName(), obj1.getAttributeTemplateColor());
	    final BufferedImageIcon img2 = GraphicsManager.getImage(
		    ...
		    obj2.getTemplateColor(), obj2.getAttributeName(), obj2.getAttributeTemplateColor());
	    final BufferedImageIcon img3 = GraphicsManager.getImage(
		    obj3.editorRenderHook(y, x, this.elMgr.getEditorLocationZ()), obj3.getBaseName(),
		    obj3.getTemplateColor(), obj3.getAttributeName(), obj3.getAttributeTemplateColor());
	    this.drawGrid[xFix][yFix].setIcon(GraphicsManager.getVirtualCompositeImage(img1, img2, img3));
	...
	if (!nested) {
	    ...
	    gridX = x / GraphicsManager.getGraphicSize() + this.evMgr.getViewingWindowLocationX() - xOffset + yOffset;
	    gridY = y / GraphicsManager.getGraphicSize() + this.evMgr.getViewingWindowLocationY() + xOffset - yOffset;
	    try {
    ...
    private void autoGenerateTransitions(final MazeObject instance, final int gridX, final int gridY) {
    ...
    private void autoGenerateTransitions1(final MazeObject instance, final int gridX, final int gridY) {
	// Generate transitions automatically
	if (!instance.isOfType(TypeConstants.TYPE_GENERATION_ELIGIBLE)) {
	    return;
	}
	final Application app = LoopChute.getApplication();
	final MazeObject[] generatedObjects = app.getObjects().getAllGeneratedTypedObjects();
	final int generatedOffset = app.getObjects().getAllObjects().length - generatedObjects.length;
	MazeObject obj1;
	try {
	    obj1 = app.getMazeManager().getMaze().getCell(gridX - 1, gridY - 1, this.elMgr.getEditorLocationZ(),
		    this.elMgr.getEditorLocationE());
	...
	if (!obj1.equals(instance)) {
		...
		if (generatedObjects[z] instanceof GeneratedEdge) {
		    ...
		    if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(obj1.getName())) {
			// Inverted
		    ...
		    } else if (ge.getSource1().equals(obj1.getName()) && ge.getSource2().equals(instance.getName())) {
			// Normal
    ...
    private void autoGenerateTransitions2(final MazeObject instance, final int gridX, final int gridY) {
	// Generate transitions automatically
	if (!instance.isOfType(TypeConstants.TYPE_GENERATION_ELIGIBLE)) {
	    return;
	}
	...
	MazeObject obj2;
	try {
	    obj2 = app.getMazeManager().getMaze().getCell(gridX, gridY - 1, this.elMgr.getEditorLocationZ(),
		    this.elMgr.getEditorLocationE());
	} catch (final ArrayIndexOutOfBoundsException aioob2) {
	    obj2 = new EmptyVoid();
	}
	if (!obj2.equals(instance)) {
		...
		for (int z = 0; z < generatedObjects.length; z++) {
		    if (generatedObjects[z] instanceof GeneratedEdge) {
			final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
			if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(ge2.getSource2())) {
			    // Inverted
		...
		for (int z = 0; z < generatedObjects.length; z++) {
		    if (generatedObjects[z] instanceof GeneratedEdge) {
			final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
			if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(obj2.getName())) {
			    // Inverted
			    if (ge.getDirectionName().equals("North")) {
				this.currentObjectIndex = generatedOffset + z;
				this.editObject(gridX, gridY - 1, true);
    ...
    private void autoGenerateTransitions3(final MazeObject instance, final int gridX, final int gridY) {
	// Generate transitions automatically
	if (!instance.isOfType(TypeConstants.TYPE_GENERATION_ELIGIBLE)) {
	    return;
	}
	...
	MazeObject obj3;
	try {
	    obj3 = app.getMazeManager().getMaze().getCell(gridX + 1, gridY - 1, this.elMgr.getEditorLocationZ(),
		    this.elMgr.getEditorLocationE());
	} catch (final ArrayIndexOutOfBoundsException aioob2) {
	    obj3 = new EmptyVoid();
	}
	if (!obj3.equals(instance)) {
		...
		if (generatedObjects[z] instanceof GeneratedEdge) {
		    final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
		    if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(obj3.getName())) {
			// Inverted
		    ...
		    } else if (ge.getSource1().equals(obj3.getName()) && ge.getSource2().equals(instance.getName())) {
			// Normal
    ...
    private void autoGenerateTransitions4(final MazeObject instance, final int gridX, final int gridY) {
	// Generate transitions automatically
	if (!instance.isOfType(TypeConstants.TYPE_GENERATION_ELIGIBLE)) {
	    return;
	}
	...
	MazeObject obj4;
	try {
	    obj4 = app.getMazeManager().getMaze().getCell(gridX - 1, gridY, this.elMgr.getEditorLocationZ(),
		    this.elMgr.getEditorLocationE());
	} catch (final ArrayIndexOutOfBoundsException aioob2) {
	    obj4 = new EmptyVoid();
	}
	if (!obj4.equals(instance)) {
		...
		for (int z = 0; z < generatedObjects.length; z++) {
		    if (generatedObjects[z] instanceof GeneratedEdge) {
			final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
			if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(ge4.getSource2())) {
			    // Inverted
		...
		for (int z = 0; z < generatedObjects.length; z++) {
		    if (generatedObjects[z] instanceof GeneratedEdge) {
			final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
			if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(obj4.getName())) {
			    // Inverted
			    if (ge.getDirectionName().equals("West")) {
				this.currentObjectIndex = generatedOffset + z;
				this.editObject(gridX - 1, gridY, true);
    ...
    private void autoGenerateTransitions6(final MazeObject instance, final int gridX, final int gridY) {
	// Generate transitions automatically
	if (!instance.isOfType(TypeConstants.TYPE_GENERATION_ELIGIBLE)) {
	    return;
	}
	...
	MazeObject obj6;
	try {
	    obj6 = app.getMazeManager().getMaze().getCell(gridX + 1, gridY, this.elMgr.getEditorLocationZ(),
		    this.elMgr.getEditorLocationE());
	} catch (final ArrayIndexOutOfBoundsException aioob2) {
	    obj6 = new EmptyVoid();
	}
	if (!obj6.equals(instance)) {
		...
		for (int z = 0; z < generatedObjects.length; z++) {
		    if (generatedObjects[z] instanceof GeneratedEdge) {
			final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
			if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(ge6.getSource2())) {
			    // Inverted
			    if (ge.getDirectionName().equals("East")) {
				this.currentObjectIndex = generatedOffset + z;
				this.editObject(gridX + 1, gridY, true);
		...
		for (int z = 0; z < generatedObjects.length; z++) {
		    if (generatedObjects[z] instanceof GeneratedEdge) {
			final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
			if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(obj6.getName())) {
			    // Inverted
			    if (ge.getDirectionName().equals("East")) {
				this.currentObjectIndex = generatedOffset + z;
				this.editObject(gridX + 1, gridY, true);
    ...
    private void autoGenerateTransitions7(final MazeObject instance, final int gridX, final int gridY) {
	// Generate transitions automatically
	if (!instance.isOfType(TypeConstants.TYPE_GENERATION_ELIGIBLE)) {
	    return;
	}
	...
	MazeObject obj7;
	try {
	    obj7 = app.getMazeManager().getMaze().getCell(gridX - 1, gridY + 1, this.elMgr.getEditorLocationZ(),
		    this.elMgr.getEditorLocationE());
	} catch (final ArrayIndexOutOfBoundsException aioob2) {
	    obj7 = new EmptyVoid();
	}
	if (!obj7.equals(instance)) {
		...
		if (generatedObjects[z] instanceof GeneratedEdge) {
		    final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
		    if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(obj7.getName())) {
			// Inverted
		    ...
		    } else if (ge.getSource1().equals(obj7.getName()) && ge.getSource2().equals(instance.getName())) {
			// Normal
    ...
    private void autoGenerateTransitions8(final MazeObject instance, final int gridX, final int gridY) {
	// Generate transitions automatically
	if (!instance.isOfType(TypeConstants.TYPE_GENERATION_ELIGIBLE)) {
	    return;
	}
	...
	MazeObject obj8;
	try {
	    obj8 = app.getMazeManager().getMaze().getCell(gridX, gridY + 1, this.elMgr.getEditorLocationZ(),
		    this.elMgr.getEditorLocationE());
	} catch (final ArrayIndexOutOfBoundsException aioob2) {
	    obj8 = new EmptyVoid();
	}
	if (!obj8.equals(instance)) {
		...
		for (int z = 0; z < generatedObjects.length; z++) {
		    if (generatedObjects[z] instanceof GeneratedEdge) {
			final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
			if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(ge8.getSource2())) {
			    // Inverted
			    if (ge.getDirectionName().equals("South")) {
				this.currentObjectIndex = generatedOffset + z;
				this.editObject(gridX, gridY + 1, true);
		...
		for (int z = 0; z < generatedObjects.length; z++) {
		    if (generatedObjects[z] instanceof GeneratedEdge) {
			final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
			if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(obj8.getName())) {
			    // Inverted
			    if (ge.getDirectionName().equals("South")) {
				this.currentObjectIndex = generatedOffset + z;
				this.editObject(gridX, gridY + 1, true);
    ...
    private void autoGenerateTransitions9(final MazeObject instance, final int gridX, final int gridY) {
	// Generate transitions automatically
	if (!instance.isOfType(TypeConstants.TYPE_GENERATION_ELIGIBLE)) {
	    return;
	}
	...
	MazeObject obj9;
	try {
	    obj9 = app.getMazeManager().getMaze().getCell(gridX + 1, gridY + 1, this.elMgr.getEditorLocationZ(),
		    this.elMgr.getEditorLocationE());
	} catch (final ArrayIndexOutOfBoundsException aioob2) {
	    obj9 = new EmptyVoid();
	}
	if (!obj9.equals(instance)) {
		...
		if (generatedObjects[z] instanceof GeneratedEdge) {
		    final GeneratedEdge ge = (GeneratedEdge) generatedObjects[z];
		    if (ge.getSource1().equals(instance.getName()) && ge.getSource2().equals(obj9.getName())) {
			// Inverted
		    ...
		    } else if (ge.getSource1().equals(obj9.getName()) && ge.getSource2().equals(instance.getName())) {
			// Normal
	...
	try {
		...
		if (mo2 == null) {
		    LoopChute.getApplication().showMessage("This object has no properties");
		} else {
		    this.checkTwoWayTeleportPair(this.elMgr.getEditorLocationZ());
		    this.updateUndoHistory(this.savedMazeObject, gridX, gridY, this.elMgr.getEditorLocationZ(),
			    this.elMgr.getEditorLocationW(), this.elMgr.getEditorLocationE());
	...
	final String resp = CommonDialogs.showTextInputDialogWithDefault("Key Count (Number of Sun/Moon Stones needed)",
		"Editor", def);
	int respVal = -1;
	try {
	...
	final Application app = LoopChute.getApplication();
	final String choice = CommonDialogs.showInputDialog("Edit What?", "Editor", MazeEditor.choices,
		MazeEditor.choices[0]);
	if (choice != null) {
	...
	case TELEPORT_TYPE_INVISIBLE_BLOCK:
	    LoopChute.getApplication().showMessage("Click to set teleport destination");
	    break;
	...
	case TELEPORT_TYPE_INVISIBLE_ONESHOT_CHAIN:
	    ...
	    break;
	case TELEPORT_TYPE_BLOCK:
	    app.getMazeManager().getMaze().setCell(new BlockTeleport(destX, destY, destZ),
		    this.elMgr.getEditorLocationX(), this.elMgr.getEditorLocationY(), this.elMgr.getCameFromZ(),
		    MazeConstants.LAYER_OBJECT);
	    break;
	case TELEPORT_TYPE_INVISIBLE_BLOCK:
	    app.getMazeManager().getMaze().setCell(new InvisibleBlockTeleport(destX, destY, destZ),
		    this.elMgr.getEditorLocationX(), this.elMgr.getEditorLocationY(), this.elMgr.getCameFromZ(),
		    MazeConstants.LAYER_OBJECT);
	    break;
	default:
	...
	if (saved) {
	    ...
	    if (success) {
		this.fixLimits();
		app.getMazeManager().getMaze().fillLevel(PreferencesManager.getEditorDefaultFill(), new Empty());
	...
	if (this.confirmNonUndoable("overwrite the active floor within the active level with default data")) {
	    LoopChute.getApplication().getMazeManager().getMaze().fillFloor(this.elMgr.getEditorLocationZ());
	...
	if (this.confirmNonUndoable("overwrite the active level with random data")) {
		...
		LoopChute.getApplication().getMazeManager().getMaze().fillLevelRandomlyCustom();
	    } else {
		LoopChute.getApplication().getMazeManager().getMaze().fillLevelRandomly();
	    }
	...
	if (this.confirmNonUndoable("overwrite the active layer on the active level with default data")) {
	    LoopChute.getApplication().getMazeManager().getMaze().fillLayer(this.elMgr.getEditorLocationE());
	...
	if (this.confirmNonUndoable(
	    ...
	    LoopChute.getApplication().getMazeManager().getMaze().fillFloorAndLayer(this.elMgr.getEditorLocationZ(),
		    this.elMgr.getEditorLocationE());
	...
	if (this.confirmNonUndoable("overwrite the active layer on the active level with random data")) {
	    if (LoopChute.getApplication().getMenuManager().useFillRuleSets()) {
		LoopChute.getApplication().getMazeManager().getMaze()
			.fillLevelAndLayerRandomlyCustom(this.elMgr.getEditorLocationE());
	    } else {
		LoopChute.getApplication().getMazeManager().getMaze()
			.fillLevelAndLayerRandomly(this.elMgr.getEditorLocationE());
	    }
	    LoopChute.getApplication().showMessage("Level and layer randomly filled.");
	    LoopChute.getApplication().getMazeManager().setDirty(true);
	    this.redrawEditor();
	}
    }
	...
	if (this.confirmNonUndoable(
	    ...
	    if (LoopChute.getApplication().getMenuManager().useFillRuleSets()) {
		LoopChute.getApplication().getMazeManager().getMaze().fillFloorAndLayerRandomlyCustom(
			this.elMgr.getEditorLocationZ(), this.elMgr.getEditorLocationE());
	    } else {
		LoopChute.getApplication().getMazeManager().getMaze()
			.fillFloorAndLayerRandomly(this.elMgr.getEditorLocationZ(), this.elMgr.getEditorLocationE());
	    }
	    LoopChute.getApplication().showMessage("Floor and layer randomly filled.");
	    LoopChute.getApplication().getMazeManager().setDirty(true);
	    this.redrawEditor();
	}
    }
	...
	if (!this.goToDestMode) {
	    ...
	    LoopChute.getApplication().showMessage("Click a teleport to go to its destination");
	}
    }
	...
	if (this.goToDestMode) {
	    ...
	    final int xOffset = this.vertScroll.getValue() - this.vertScroll.getMinimum();
	    final int yOffset = this.horzScroll.getValue() - this.horzScroll.getMinimum();
	    final int locX = x / GraphicsManager.getGraphicSize() + this.evMgr.getViewingWindowLocationX() - xOffset
		    + yOffset;
	    final int locY = y / GraphicsManager.getGraphicSize() + this.evMgr.getViewingWindowLocationY() + xOffset
		    - yOffset;
	    final int locZ = this.elMgr.getEditorLocationZ();
	    final MazeObject there = LoopChute.getApplication().getMazeManager().getMazeObject(locX, locY, locZ,
		    MazeConstants.LAYER_OBJECT);
		...
		LoopChute.getApplication().showMessage("This object does not have a destination.");
	    }
	}
    }
