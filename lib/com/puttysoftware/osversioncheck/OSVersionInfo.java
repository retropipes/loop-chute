...
public class OSVersionInfo implements Comparable<OSVersionInfo> {
    ...
    public static final OSVersionInfo TIGER = new OSVersionInfo(OSVersionInfo.MAC_OS_X, 10, 4,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LEOPARD = new OSVersionInfo(OSVersionInfo.MAC_OS_X, 10, 5,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo SNOW_LEOPARD = new OSVersionInfo(OSVersionInfo.MAC_OS_X, 10, 6,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LION = new OSVersionInfo(OSVersionInfo.MAC_OS_X, 10, 7,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo WIN2K = new OSVersionInfo(OSVersionInfo.WINDOWS, 5, 0,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo XP = new OSVersionInfo(OSVersionInfo.WINDOWS, 5, 1, OSVersionInfo.OS_VERSION_ANY,
	    OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo VISTA = new OSVersionInfo(OSVersionInfo.WINDOWS, 6, 0,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo SEVEN = new OSVersionInfo(OSVersionInfo.WINDOWS, 6, 1,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LINUX22 = new OSVersionInfo(OSVersionInfo.LINUX, 2, 2,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LINUX24 = new OSVersionInfo(OSVersionInfo.LINUX, 2, 4,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LINUX26 = new OSVersionInfo(OSVersionInfo.LINUX, 2, 6,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    public static final OSVersionInfo LINUX30 = new OSVersionInfo(OSVersionInfo.LINUX, 3, 0,
	    OSVersionInfo.OS_VERSION_ANY, OSVersionInfo.OS_VERSION_ANY);
    // Fields
